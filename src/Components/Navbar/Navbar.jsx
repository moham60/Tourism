...
export default function Navbar() {
  return (
    <div>
      <nav className="bg-white fixed top-0 left-0 right-0 border-gray-200 dark:bg-gray-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className="flex items-center  md:order-2">
            <div className="relative mr-4">
              <div className="flex icons gap-5 items-center md:order-2">
                <button className=" cursor-pointer  searchIcon ">
                  <i className="fa-solid fa-magnifying-glass" />
                </button>
                <button className=" cursor-pointer userIcon ">
                  <i className="fa-solid fa-user" />
                </button>
                <button className=" cursor-pointer  cartIcon">
            ...
            <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                <Link
                  ...
                  smooth
                  duration={500}
                  className="block  cursor-pointer py-2 px-3 text-white bg-blue-700 rounded-sm md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500"
                  aria-current="page">
                  Home
                </Link>
              </li>
