    ...
    <section className="bg-gray-100 py-16 px-6" id="contact">
      <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-start">
        ...
        >
          ...
          <div>
            <label className="block mb-1 text-sm font-medium text-gray-700">Message <span className="text-red-500">*</span></label>
            <textarea
              name="message"
              ...
              className={`w-full border ${error ? "border-red-500" : "border-gray-300"} rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500`}
            ></textarea>
